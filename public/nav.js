...
var M = {
  ...
  clock24:'math',rose:'math',gap_pairs:'math',depth_quad:'math',fourteen:'math',d_chain:'math',partitions:'math',modular_forms:'math',eta_bridge:'math',decality:'math',heegner:'math',lambda_chain:'math',arcsine_cumulant:'math',cunningham:'math',monster_moonshine:'math',lie_algebra:'math',bernoulli:'math',k_squared_stop:'math',pell_twins:'math',universal_boundary:'math',depth_return:'math',figurate_bridge:'math',eigenvalue_swim:'math',mirror:'math',equator:'math',mirror_cost:'math',shadow_eval:'math',stormer_pairs:'math',fano_e8:'math',smooth_census:'math',cyclotomic_fibonacci:'math',
