...
F5 THE SHARPENED OBSTRUCTION (what the cell now costs to settle).
   ...
   arithmetic, ubiquitously — and the assembly followed:
   explore_stall_assembly.py exhibits unresourced strict stalls
   where the horizon cuts inside the trade window, so this rig's
   desert is a property of its battery and horizons.)
