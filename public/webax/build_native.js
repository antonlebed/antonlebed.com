...
const FILES = [
  ...
  'page_heart.ax', 'page_sandpile.ax', 'page_swim.ax', 'page_repl.ax', 'page_prerequisites.ax', 'page_tutorial.ax', 'page_arc.ax', 'page_mesh.ax', 'page_image_filter.ax', 'page_ecc_live.ax', 'pages_observe.ax', 'pages_living.ax',
  'router.ax'
];
