...
var M = {
  ...
  sm:'physics',quantum:'physics',thermo:'physics',
...
var T = {
  ...
  sm:'25/25 Standard Model',quantum:'Quantum from Five Primes',thermo:'Thermodynamics',
...
if(_li>0){
  ...
  var _titles={fr:{
    ...
    sm:'25/25 Modele Standard',quantum:'M\u00e9canique quantique',thermo:'Thermodynamique',
  ...
  ru:{
    ...
    sm:'25/25 Стандартная модель',quantum:'Квантовая механика',thermo:'Термодинамика',
