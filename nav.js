...
var M = {
  ...
  sm:'physics',quantum:'physics',thermo:'physics',chemistry:'physics',em:'physics',gr:'physics',cosmo:'physics',classical:'physics',
...
var T = {
  ...
  sm:'25/25 Standard Model',quantum:'Quantum from Five Primes',thermo:'Thermodynamics',chemistry:'Chemistry from Five Primes',em:'Electromagnetism',gr:'General Relativity',cosmo:'Cosmology from Five Primes',classical:'Classical Mechanics',
...
if(_li>0){
  ...
  var _titles={fr:{
    ...
    sm:'25/25 Modele Standard',quantum:'M\u00e9canique quantique',thermo:'Thermodynamique',chemistry:'Chimie des cinq premiers',em:'\u00c9lectromagn\u00e9tisme',gr:'Relativit\u00e9 g\u00e9n\u00e9rale',cosmo:'Cosmologie des cinq premiers',classical:'M\u00e9canique classique',
  ...
  ru:{
    ...
    sm:'25/25 Стандартная модель',quantum:'Квантовая механика',thermo:'Термодинамика',chemistry:'Химия пяти простых',em:'Электромагнетизм',gr:'Общая теория относительности',cosmo:'Космология пяти простых',classical:'Классическая механика',
