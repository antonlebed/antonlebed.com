...
var M = {
  ...
  sm:'physics',quantum:'physics',thermo:'physics',chemistry:'physics',em:'physics',
...
var T = {
  ...
  sm:'25/25 Standard Model',quantum:'Quantum from Five Primes',thermo:'Thermodynamics',chemistry:'Chemistry from Five Primes',em:'Electromagnetism',
...
if(_li>0){
  ...
  var _titles={fr:{
    ...
    sm:'25/25 Modele Standard',quantum:'M\u00e9canique quantique',thermo:'Thermodynamique',chemistry:'Chimie des cinq premiers',em:'\u00c9lectromagn\u00e9tisme',
  ...
  ru:{
    ...
    sm:'25/25 Стандартная модель',quantum:'Квантовая механика',thermo:'Термодинамика',chemistry:'Химия пяти простых',em:'Электромагнетизм',
