...
export default {
  async fetch(request, env) {
    ...
    const REDIRECTS = {
      ...
      '/reading/output': '/redundancy/output',
      '/reading/redundant': '/redundancy/redundant',
      '/reading/polynomial': '/redundancy/polynomial',
      '/reading/chains': '/redundancy/chains',
    };
    ...
    const PAGES = {
      ...
      '/claims/redundancy': 'claims-redundancy',
      '/claims/measure': 'claims-measure',
      '/claims/growth': 'claims-growth',
      '/claims/fields': 'claims-fields',
      '/claims/cascade': 'claims-cascade',
      '/claims/inside': 'claims-inside',
      '/claims/probe': 'claims-probe',
      '/claims/blind': 'claims-blind',
      '/claims/irreducibility': 'claims-irreducibility',
      '/claims/thermal': 'claims-thermal',
      '/claims/constants': 'claims-constants',
