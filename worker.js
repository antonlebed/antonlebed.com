  ...
  async fetch(request, env) {
    ...
    try {
      ...
      var boot = '<script>' +
        ...
        'kingdom:function(n){n=((n%_N)+_N)%_N;if(n===0)return 0;var ps=[2,3,5,7,11];for(var i=0;i<5;i++)if(n%ps[i]===0)return ps[i];return 1},' +
        'eigenvalue:function(n){n=((n%_N)+_N)%_N;var t=0;for(var i=0;i<5;i++)t+=2*Math.cos(2*Math.PI*(n%qs[i])/qs[i]);return Math.round(t*1000)},' +
        'mirror:function(n){return((970200-(n%970200))%970200)},crt_r:function(n,c){return((n%_N)+_N)%_N%qs[c]},' +
        'rand:function(n){return Math.floor(Math.random()*n)},' +
        'grid:function(){return 0},gset:function(){return 0},show_grid:function(){return 0},hflip:function(){return 0},' +
        'vflip:function(){return 0},rot90:function(){return 0},transpose:function(){return 0},grid_eq:function(){return 0}}});' +
